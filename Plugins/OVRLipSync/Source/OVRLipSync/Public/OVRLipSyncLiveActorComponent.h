...
protected:
	...
	void ProcessSoundWave(USoundWave *SoundWave);

	void ConvertAudioData(const TArray<uint8> &AudioData, TArray<int16_t> &OutAudioBuffer);

	void OnVisemesUpdated(const TArray<float> &Visemes);

	UFUNCTION()
	void OnAudioPlaybackProgress();
